...
A personal gaming tracker for Android. Search your backlog, track progress across custom categories, and share your library — no external server required.
...
- Organize by status — To Play, Playing, Beaten
